...
reg add "%KernelKey%" /v SchedulerAssistThreadFlagOverride /t REG_DWORD /d 0 /f
...
reg add "%DwmKey%" /v OverlayMinFPS /t REG_DWORD /d 15 /f
...
reg add "%DwmKey%" /v OverlayTestMode /t REG_DWORD /d 0 /f
reg add "%DwmKey%" /v ParallelModePolicy /t REG_DWORD /d 1 /f
reg add "%DwmKey%" /v ParallelModeRateThreshold /t REG_DWORD /d 119 /f
